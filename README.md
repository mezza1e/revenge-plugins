...
```text
https://cdn.jsdelivr.net/gh/mezza1e/revenge-plugins@2.4.0/
```
...
* **ByeBlocked Only:**
  `https://cdn.jsdelivr.net/gh/mezza1e/revenge-plugins@2.4.0/byeblocked/`

* **MemoryEngine Only:**
  `https://cdn.jsdelivr.net/gh/mezza1e/revenge-plugins@2.4.0/memoryengine/`

* **MessageReliability Only:**
  `https://cdn.jsdelivr.net/gh/mezza1e/revenge-plugins@2.4.0/messagereliability/`
