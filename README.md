# Revengecord Plugins by mezza1e (v4.4.0)
...
```text
https://cdn.jsdelivr.net/gh/mezza1e/revenge-plugins@4.4.0/
```
...
### 1. HideBlockedInSettings (v1.5.2)
...
* Pure lightweight component interception matching v4.0.0 stability.

```text
https://cdn.jsdelivr.net/gh/mezza1e/revenge-plugins@4.4.0/hideblockedinsettings/
```

---

### 2. RemoveBlockedUsers (v1.8.3)
...
```text
https://cdn.jsdelivr.net/gh/mezza1e/revenge-plugins@4.4.0/removeblockedusers/
```

---

### 3. BypassBlockedOrIgnored (v1.0.14)
...
```text
https://cdn.jsdelivr.net/gh/mezza1e/revenge-plugins@4.4.0/bypassblockedorignored/
```
